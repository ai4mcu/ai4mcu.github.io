const translations = {
    "ko": {
        ...
        "hand_description": "MediaPipe로 검지좌표, 엄지-검지 길이, 손가락 카운팅, 양손 등을 사용하여 MCU를 제어합니다.",
        "voice_command_title": "음성인식 서비스",
        "voice_command_description": "Web Speech API로 음성인식 결과를 사용하여 MCU를 제어합니다.",
        "service5_title": "서비스 5",
        ...
        "app_description_3": "🌐 Chrome, Edge 브라우저에서 테스트 되었습니다.",
        "app_description_5": "🚀 인공지능에 다양한 출력장치를 연결하여 AIoT 애플리케이션을 제작해 보세요.",
        "ccl": "📜 CCL: BY-NC-ND",
        ...
        // ==================== TM 페이지 (TM_AllinOne4MCU_V10.html) ====================
        ...
        "guide_tm_4": "⚙️ 하드웨어는 블록코딩이나 텍스트 코딩을 이용해 사전에 코드 업로드가 필요합니다.",
        "guide_tm_5": "인식된 결과가 자동으로 MCU로 전송됩니다.",
        "developer_info_tm": "WebSerial과 WebBLE를 이용해 TM 결과를 유/무선 MCU로 전송하는 웹앱입니다.",
        ...
        // ==================== 얼굴 인식 페이지 (FACE_AllinOne4MCU_V10.html) ====================
        ...
        "developer_info_face": "WebSerial과 WebBLE를 이용해 얼굴 인식 결과를 유/무선으로 MCU에 전송하는 웹앱입니다.",
        "loading_model": "모델 로딩 중...",
        "recognizing": "인식 중...",
        "serial_connect_error": "시리얼 연결 실패: {error}",
        "ble_connect_error": "블루투스 연결 실패: {error}",

        // ==================== 손가락 인식 페이지 (HAND_AllinOne4MCU_V10.html) ====================
        ...
        "start_recognition": "인식 시작",
        "stop_recognition": "인식 정지",
        "recognition_waiting": "인식 대기중",
        "voice_recognizing": "음성 인식 중...",
        "recognition_error": "인식 오류",
        "final_recognized_sentence": "최종 인식된 문장:",
        "command_transmission_settings": "명령어/전송 값 설정 (최대 20개)",
        "guide_voice_1": "사용할 언어를 선택합니다.",
        "guide_voice_2": "'+' 버튼을 눌러 인식할 단어와 MCU로 보낼 값을 설정합니다. (최대 20개)",
        "guide_voice_3": "시리얼 또는 블루투스로 제어할 장치를 연결합니다.",
        "guide_voice_4": "'인식 시작' 버튼을 누르고 설정한 단어를 포함하여 말합니다.",
        "guide_voice_5": "단어가 인식되면 해당 칸이 붉게 강조되며 설정된 값이 자동으로 전송됩니다.",
        "developer_info_voice": "WebSerial과 WebBLE를 이용해 음성 인식 결과를 유/무선 MCU로 전송하는 웹앱입니다.",
        "browser_not_supported": "이 브라우저는 음성 인식을 지원하지 않습니다. Chrome 브라우저를 사용해주세요.",
        "max_commands_limit": "명령어는 최대 20개까지 추가할 수 있습니다.",
        "word_to_recognize_placeholder": "인식할 단어 (예: 불 켜)",
        "transmission_value_placeholder": "전송 값 (예: 1)"
    },
    "en": {
        ...
        "hand_description": "Control MCUs using MediaPipe for index finger coordinates, thumb-index length, counting, dual-hand, etc.",
        "voice_command_title": "Voice Recognition Service",
        "voice_command_description": "Control your MCU with voice recognition results from Google's Web Speech API.",
        ...
        "app_description_3": "🌐 Tested in Chrome and Edge browsers.",
        ...
        // ==================== TM Page (TM_AllinOne4MCU_V10.html) ====================
        "tm_page_title": "🤖 TM All-in-One for MCU",
        ...
        "guide_tm_4": "⚙️ Hardware requires prior code upload using block or text coding.",
        "guide_tm_5": "The recognized result is automatically sent to the MCU.",
        "developer_info_tm": "A local web app that sends TM results to wired/wireless MCUs using WebSerial and WebBLE.",
        ...
        // ==================== Face Recognition Page (FACE_AllinOne4MCU_V10.html) ====================
        ...
        "developer_info_face": "A local web app that sends face recognition results to wired/wireless MCUs using WebSerial and WebBLE.",
        "loading_model": "Loading model...",
        "recognizing": "Recognizing...",
        "serial_connect_error": "Serial connection failed: {error}",
        "ble_connect_error": "Bluetooth connection failed: {error}",
        
        // ==================== Hand Recognition Page (HAND_AllinOne4MCU_V10.html) ====================
        ...
        "recognition_waiting": "Waiting for Recognition",
        "voice_recognizing": "Listening...",
        "recognition_error": "Recognition Error",
        "final_recognized_sentence": "Final Recognized Sentence:",
        "command_transmission_settings": "Command/Value Settings (Max 20)",
        "guide_voice_1": "Select the language to use.",
        "guide_voice_2": "Press '+' to set words to recognize and values to send (Max 20).",
        "guide_voice_3": "Connect your device to control via Serial or Bluetooth.",
        "guide_voice_4": "Press 'Start Recognition' and speak, including the word you set.",
        "guide_voice_5": "If the word is recognized, the row will be highlighted and the value sent automatically.",
        "developer_info_voice": "A web app that sends voice recognition results to wired/wireless MCUs using WebSerial and WebBLE.",
        "browser_not_supported": "This browser does not support voice recognition. Please use a Chrome browser.",
        "max_commands_limit": "You can add up to 20 commands.",
        "word_to_recognize_placeholder": "Word to recognize (e.g., light on)",
        "transmission_value_placeholder": "Value to send (e.g., 1)"
    }
};
...
function setLanguage() {
    ...
    document.querySelectorAll('[data-translate-key]').forEach(el => {
        ...
        } else if (key.includes('subtitle') || key.includes('copyright') || key.includes('tm_page_subtitle')) {
