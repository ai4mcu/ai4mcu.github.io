const translations = {
    "ko": {
        ...
        "voice_page_title": "인성인식 서비스 for MCU",
        "voice_page_h1": "🎤 인성인식 서비스",
        "voice_page_subtitle": "Web Speech API를 사용하여 음성으로 MCU를 제어합니다.",
        "voice_control_title": "음성인식 제어",
        "language_select_label": "언어 선택",
        "start_voice_recognition": "인식 시작",
        "stop_voice_recognition": "인식 정지",
        "status_waiting_recognition": "인식 대기중",
        "status_listening": "음성 인식 중...",
        "status_error": "인식 오류",
        "final_transcript_label": "최종 인식된 문장:",
        "command_settings_title": "명령어/전송 값 설정 (최대 20개)",
        "placeholder_command_word": "인식할 단어 (예: 불 켜)",
        "placeholder_send_value": "전송 값 (예: 1)",
        ...
        "developer_info_voice": "🎤 Web Speech API를 이용해 음성 인식 결과를 유/무선 MCU로 전송하는 웹앱입니다."
    },
    "en": {
        ...
        "voice_command_title": "Voice Command Service",
        "voice_command_description": "Control your MCU using voice recognition results from the Web Speech API.",
        ...
        "voice_page_title": "Voice Command Service for MCU",
        "voice_page_h1": "🎤 Voice Command Service",
        "voice_page_subtitle": "Control your MCU with your voice using the Web Speech API.",
        "voice_control_title": "Voice Recognition Control",
        "language_select_label": "Select Language",
        "start_voice_recognition": "Start Recognition",
        "stop_voice_recognition": "Stop Recognition",
        "status_waiting_recognition": "Waiting for Recognition",
        "status_listening": "Listening...",
        "status_error": "Recognition Error",
        "final_transcript_label": "Final Recognized Sentence:",
        "command_settings_title": "Command/Value Settings (Max 20)",
        "placeholder_command_word": "Word to recognize (e.g., light on)",
        "placeholder_send_value": "Value to send (e.g., 1)",
        ...
        "developer_info_voice": "🎤 A web app that sends voice recognition results to wired/wireless MCUs using the Web Speech API."
    }
};
